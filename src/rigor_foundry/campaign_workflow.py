...
def create_campaign(
    ...
    *,
    ...
    report = scan_repository(repository_root, policy_path)
    ...
    path = store_campaign(repository, audit_root, campaign)
...
def execute_campaign(
    ...
    *,
    ...
    directory = store_run(campaign_path, report, attestation)
