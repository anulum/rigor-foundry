...
| CRA component inventory and OSV awareness | Real Git and CLI imports for CycloneDX 1.5/1.6 and SPDX 2.3; stable-file bounds; exact source replay; Git drift; complete OSV adapter binding; explicit exploitation boundary; 100% isolated statement/branch coverage | Supported Python matrix, installed-wheel commands, aggregate branch-aware coverage, and no-network/static import guards |
...
On 2026-07-20, the CRA component-evidence owner passed 54 focused real-file, real-Git,
and CLI tests. The five new production modules covered 664 statements and 194
branches at 100%. The affected reporting/component-evidence selection passed 88 tests with
...
The component-evidence implementation contains bounded protocol parsing and
append-only I/O, not a numeric or
