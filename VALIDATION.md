...
| Rule maturity | Exact report/review case projection, explicit thresholds, conservative statistics, finite probation reasons, strict parsing, 100% isolated branch coverage, and real CLI/gate wiring | Same contracts plus aggregate branch-aware coverage and installed-wheel CLI smoke |
